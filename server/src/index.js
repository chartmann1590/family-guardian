...
import placeSubRoutes from './routes/placeSubscriptions.js';
...
await fastify.register(placeSubRoutes, { db });
await fastify.register(profileRoutes, { db, uploadsDir: UPLOADS_DIR });
await fastify.register(pauseRoutes, { db });
await fastify.register(sosRoutes, { db });
await fastify.register(checkinRoutes, { db, uploadsDir: UPLOADS_DIR });
await fastify.register(messageRoutes, { db, uploadsDir: UPLOADS_DIR });
